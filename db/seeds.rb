User.create!([
  { name: "lyle", email: "lyle@lyle.com", password: "password", admin: true },
  { name: "bobby", email: "bobby@email.com", password: "password", admin: true },
  { name: "kevin", email: "kevin@kevin.com", password: "password", admin: true },
  { name: "emily", email: "emily@emily.com", password: "password", admin: true },
  { name: "bob", email: "bob@bob.com", password: "password", admin: true },
  { name: "jo", email: "jo@jo.com", password: "password", admin: true },
])
Supplier.create!([
