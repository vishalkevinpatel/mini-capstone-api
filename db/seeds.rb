...
# Image.create!([
#   {name: "christmas tree", price: "45.0", description: "christmas tree", inventory: nil, supplier_id: 2},
#   {name: "christmas tree", price: "45.0", description: "christmas tree", inventory: nil, supplier_id: 2},
#   {name: "christmas tree", price: "45.0", description: "christmas tree", inventory: nil, supplier_id: 2},
#   {name: "christmas tree", price: "45.0", description: "christmas tree", inventory: nil, supplier_id: 2},
#   {name: "christmas tree", price: "45.0", description: "christmas tree", inventory: nil, supplier_id: 2},
...
#   {name: "christmas tree", price: "45.0", description: "christmas tree", inventory: nil, supplier_id: 2},
#   {name: "christmas tree", price: "45.0", description: "christmas tree", inventory: nil, supplier_id: 2},
#   {name: "Spoon", price: "10.0", description: "spoon", inventory: nil, supplier_id: 1},
#   {name: "Spoon", price: "10.0", description: "spoon", inventory: nil, supplier_id: 1},
#   {name: "Spoon", price: "10.0", description: "spoon", inventory: nil, supplier_id: 1},
#   {name: "spaghetti", price: "300.0", description: "idk", inventory: nil, supplier_id: 1},
#   {name: "Cutting Board", price: "30.0", description: "cutting board", inventory: nil, supplier_id: 1},
#   {name: "Cutting Board", price: "35.0", description: "cutting board", inventory: nil, supplier_id: 1},
#   {name: "Puzzle", price: "30.0", description: "puzzle", inventory: nil, supplier_id: 1},
#   {name: "scoop", price: "14.0", description: "its not a scoop", inventory: nil, supplier_id: 1}
# ])

# Image.create!([
#   { url: "https://media.istockphoto.com/id/1346236801/vector/vector-christmas-tree-isolated-on-transparent-background-beautiful-shining-christmas-tree.jpg?s=2048x2048&w=is&k=20&c=5Lhx96ujxx35zorGiZpmVirfvs9EpfBPvK7DX5xL1XA=", product_id: 7 },
